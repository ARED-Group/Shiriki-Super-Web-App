        ...
        <div className="max-w-md w-full">
          <div className="p-8 rounded-2xl bg-blue-50 shadow">
            <form onSubmit={handleSubmit} className=" px-4 py-6">
                <p className="text-[#002D74] text-lg  font-bold">Mobile Phone Verification</p>
                <p className="text-[#002D74] text-lg  font-light" >Enter the 4-digit verification code that was sent to your phone number</p>
          ...
          <div className="flex items-center justify-center">
            ...
            <a className="inline-block align-baseline font-bold text-sm text-[#002D74] hover:text-[#002D65] ml-4" href="#">
              Resend OTP
            </a>
          </div>
        </form>
