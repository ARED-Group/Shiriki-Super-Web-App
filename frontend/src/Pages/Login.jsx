      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div className="max-w-md w-full">
          <div className='page-header'>
            <h1 className='text-white text-lg  font-bold'> Welcome to BK Arena </h1>
          ...
          <div className="p-8 rounded-2xl bg-blue-50 shadow">
            ...
            <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <div className="relative flex items-center border-2 rounded-full py-2 px-3">
                  ...
                  <input 
                    ...
                    type="text" 
                    required 
                    className="w-full text-gray-800 pl-12 py-2 md:py-4 focus:outline-none text-sm  h-9 px-4 py-2 rounded-full bg-blue-50 outline-blue-600" 
                    placeholder="Name"
                    value={name}
              ...
              <label className="mt-8 ml-4 flex content-start">
                ...
                /> 
                <span className="text-sm font-semibold">I agree to the <a className="text-[#002D74] hover:underline" href="#">Terms and Conditions</a></span>
              </label>
