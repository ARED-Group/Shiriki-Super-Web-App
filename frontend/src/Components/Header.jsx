      ...
      <nav className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          <div className="hidden md:flex rounded-md border-2 border-blue-500 overflow-hidden max-w-md font-[sans-serif]">
            ...
            />
            <button type="button" className="flex items-center justify-center bg-[#007bff] px-3 md:px-5">
              <svg
          ...
          <Link to="/homepage" className="flex flex-col items-center hidden md:flex">
